...
(function () {
  ...
  var vF6 = function () {
    ...
    f82(f57, [{
      ...
      key: "set",
      value: function f65(p58, p59, p5 = 1) {
        p58 = String(p58);
        if (this.capacity === 0) {
        ...
        var v71 = new CacheNode(p58, p59, p5);
      ...
      value: function f70(p63) {
        ...
        return JSON.stringify(this, vF71, p63);
      }
    }, {
      key: "un",
