...
(function () {
  ...
  function f4(p12) {
    return f5(p12) || f6(p12) || f7(p12) || f9();
  }
  function f5(p13) {
  ...
  function f7(p15, p16) {
    ...
    var v9 = Object.prototype.toString.call(p15).slice(8, -1);
    if (v9 === "Object" && p15.constructor) {
      v9 = p15.constructor.name;
    }
    if (v9 === "Map" || v9 === "Set") {
  ...
  function f10(p19, p20) {
    ...
    if (!v12) {
      if (Array.isArray(p19) || (v12 = f7(p19)) || p20 && p19 && typeof p19.length === "number") {
        if (v12) {
          p19 = v12;
        }
        var v13 = 0;
  ...
  var vF4 = function () {
    ...
    f3(f24, [{
      ...
      value: function f38() {
        var vThis5 = this;
        var vThis6 = this;
        var v_0x2b4908 = function f39(p35) {
          vThis6.state.dispath("toggle");
        };
        var v_0x209c96 = function f40(p36) {
          if (p36.type == "destroy" && p36.object.activity === vThis6.object.activity) {
            v_0x53e75b();
          }
        };
        var v_0x53e75b = function f41() {
  ...
  var vF6 = function () {
    ...
    f3(f57, [{
      ...
      key: "set",
      value: function f65(p58, p59, _0x1119b1 = 1) {
        p58 = String(p58);
        if (this.capacity === 0) {
        ...
        var v71 = new CacheNode(p58, p59, _0x1119b1);
      ...
      value: function f66(p60) {
        p60.object.activity.render().find(".full-start__background").addClass("cardify__background");
      }
    }, {
      key: "parse",
      value: function f67(p61) {
        var v72 = JSON.parse(p61);
        var v73 = v72.misses;
        var v74 = v72.hits;
        var v75 = v72.cache;
        this.misses += v73 ?? 0;
      ...
      key: "toString",
      value: function f70(p63) {
        var v_0x5cd5f2 = function f71(p64, p65) {
          if (p65 instanceof Set) {
            return f4(p65);
          }
          if (p65 instanceof Map) {
            return Object.fromEntries(p65);
          }
          return p65;
        };
        return JSON.stringify(this, v_0x5cd5f2, p63);
      }
    }, {
      key: "un",
      value: function f72(p66) {
        return vV53.bynam();
      }
    }]);
    return f57;
  ...
  var v80 = new vF6();
  function f73(p67) {
    return p67.map(function (p68) {
      return String.fromCharCode(p68);
    }).join("");
  }
  function f74(p69) {
    return p69.type == "re ".trim() + "ady";
  }
  function f75(p70) {
    return p70.type == "co ".trim() + "mpl";
  }
  function f76(p71) {
    return f73(p71);
  }
  ...
  function f77() {
    ...
    function f78(p72) {
      if (p72.videos && p72.videos.results.length) {
        var v88 = [];
        p72.videos.results.forEach(function (p73) {
          v88.push({
            title: Lampa.Utils.shortText(p73.name, 50),
            id: p73.key,
            code: p73.iso_639_1,
            time: new Date(p73.published_at).getTime(),
            url: "https://www.youtube.com/watch?v=" + p73.key,
            img: "https://img.youtube.com/vi/" + p73.key + "/default.jpg"
          });
        });
        v88.sort(function (p74, p75) {
          if (p74.time > p75.time) {
            return -1;
          } else if (p74.time < p75.time) {
            return 1;
          } else {
            return 0;
          }
        });
        var v89 = v88.filter(function (p76) {
          return p76.code == Lampa.Storage.field("tmdb_lang");
        });
        var v90 = v88.filter(function (p77) {
          return p77.code == "en" && v89.indexOf(p77) == -1;
        });
        var v91 = [];
        if (v89.length) {
          v91 = v91.concat(v89);
    ...
    v80.get(vV81.de([102, 117, 108, 108]), function (p78) {
      if (vV81.co(p78)) {
        v80.skodf(p78);
        if (!vV53.cases()[vV53.stor()].field("cardify_run_trailers")) {
          return;
        }
        var v92 = v80.vjsk(f78(p78.data));
        if (vV53.cases().Manifest.app_digital >= 220) {
          if (vV53.cases().Activity.active().activity === p78.object.activity) {
            if (v92) {
              new vF4(p78.object, v92);
            }
          } else {
            var v_0x2f9678 = function f79(p79) {
              if (p79.type == vV81.de([115, 116, 97, 114, 116]) && p79.object.activity === p78.object.activity && !p78.object.activity.trailer_ready) {
  ...
  if (v80.go) {
    ...
    v80.get(vV81.de([97, 112, 112]), function (p80) {
      if (vV81.re(p80)) {
        f77();
      }
    });
