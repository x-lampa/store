...
(function () {
  ...
  function f82(p81, p82, p83) {
    if (p82) {
      f81(p81.prototype, p82);
    }
    if (p83) {
      f81(p81, p83);
    }
  ...
  function f83(p84) {
    return f84(p84) || f85(p84) || f86(p84) || f88();
  }
  function f84(p85) {
  ...
  function f86(p87, p88) {
    ...
    var v3 = Object.prototype.toString.call(p87).slice(8, -1);
    if (v3 === "Object" && p87.constructor) {
      v3 = p87.constructor.name;
    }
    if (v3 === "Map" || v3 === "Set") {
  ...
  function f87(p89, p90) {
    if (p90 == null || p90 > p89.length) {
      p90 = p89.length;
    }
    for (var v4 = 0, v5 = new Array(p90); v4 < p90; v4++) {
      v5[v4] = p89[v4];
    }
    return v5;
  }
  ...
  function f89(p91, p92) {
    var v6 = typeof Symbol !== "undefined" && p91[Symbol.iterator] || p91["@@iterator"];
    if (!v6) {
      if (Array.isArray(p91) || (v6 = f86(p91)) || p92 && p91 && typeof p91.length === "number") {
        if (v6) {
          p91 = v6;
        }
        var v14 = 0;
